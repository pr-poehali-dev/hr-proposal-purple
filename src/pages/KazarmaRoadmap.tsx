          ...
          <div className="text-center mb-12 pb-8 border-b-2 border-slate-200">
            ...
            <div className="mt-6 grid grid-cols-4 gap-4 text-slate-600">
              ...
              <div>
                ...
                <p className="font-semibold">22 недели (~5,5 мес)</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12">
            <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 p-8 mb-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-slate-600 mb-4">
                    Комплект ПД в составе разделов АР, КР, ИОС, ПОС
                  </p>
                  <div className="flex gap-6">
                    <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
              {[
                ...
                { week: "17-18", title: "Проект организации строительства (ПОС)", desc: "Календарный план, стройгенплан, ведомости демонтажа, схема вывоза отходов", resp: "Инженер ПОС", icon: "HardHat" },
                { week: "18-19", title: "Увязка разделов и нормоконтроль", desc: "Проверка взаимного соответствия, устранение коллизий, проверка на соответствие нормам", resp: "ГИП, нормоконтролер", icon: "CheckCheck" },
                { week: "19-20", title: "Внутренняя приемка ПД", desc: "Комплексная проверка готовой документации, подготовка к передаче Заказчику", resp: "Руководитель проекта", icon: "Clipboard" },
                { week: "20", title: "Сдача этапа 2", desc: "Передача комплекта ПД. Получение промежуточного платежа 40% (2 800 000 ₽)", resp: "Руководитель проекта", milestone: true }
              ].map((task, idx) => (
                <Card key={idx} className={`p-4 ${task.milestone ? 'bg-green-50 border-2 border-green-400' : 'hover:bg-slate-50'}`}>
                  <div className="flex items-start gap-4">
            ...
            <Card className="bg-gradient-to-r from-purple-50 to-violet-50 border-2 border-purple-300 p-8 mb-6">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-slate-900 mb-2">
                    Согласование и итоговая сдача
                  </h3>
                  <p className="text-slate-600 mb-4">
                    Согласованная ПД, полный комплект документации, итоговый акт
                  </p>
                  <div className="flex gap-6">
                    <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              <div className="space-y-6">
                {[
                  ...
                  { week: "Неделя 20", title: "Завершение разработки ПД", desc: "Передан комплект ПД, подписан акт этапа 2, получен промежуточный платеж", color: "bg-green-500" },
                  ...
                  { week: "Неделя 22", title: "Итоговая сдача", desc: "Подписан итоговый акт, передан полный комплект, получен окончательный платеж", color: "bg-green-600" }
                ].map((milestone, idx) => (
